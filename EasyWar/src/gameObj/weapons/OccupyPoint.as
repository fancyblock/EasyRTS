package gameObj.weapons 
{
	 ...
	 * @author Hejiabin
	 */
	public class OccupyPoint extends Unit 
	{
		//------------------------------ static member -------------------------------------
		...
		static protected const STATE_OCCUPYPOINT_FLY:int = 0;
		static protected const STATE_OCCUPYPOINT_BOOST:int = 1;
		static protected const STATE_OCCUPYPOINT_WAITDIE:int = 2;
		...
		protected var m_occupypointState:int = 0;
		
		//------------------------------ public function -----------------------------------
		
		/**
		 * @desc	constructor of OccupyPoint
		 */
		public function OccupyPoint() 
		{
			super();
			...
			m_type = UnitTypes.TYPE_OCCUPY_POINT;
		}
		...
		override public function Update(elapsed:Number):void 
		{
			...
			if ( m_occupypointState == STATE_OCCUPYPOINT_FLY )
			{
				...
				if ( distance.length < m_velocity )
				{
					...
					m_occupypointState = STATE_OCCUPYPOINT_BOOST;
				}
				else
				{
			...
			if ( m_occupypointState == STATE_OCCUPYPOINT_BOOST )
			{
				boost();
				
				m_state = STATE_DEAD;
				m_occupypointState = STATE_OCCUPYPOINT_WAITDIE;
			}
		}
		...
		override public function onAdd():void 
		{
			...
			m_occupypointState = STATE_OCCUPYPOINT_FLY;
		...
		protected function boost():void
		{
			...
			boost.OCCUPY_TYPE = DeadArea.BOOST_TYPE_OCCUPY;
